  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.img 
          src={project.image} 
          alt={`image ${project.id}: ${project.title}`} 
      ...
      <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between pointer-events-none">
        <div className="flex justify-between items-start">
           <span className="text-xs font-mono border border-white/30 px-3 py-1 rounded-full backdrop-blur-md bg-black/20">
             {project.category}
           </span>
           <motion.div
             variants={{
        ...
        <div>
          ...
          <motion.p 
            className="text-sm font-medium uppercase tracking-widest text-[#a8fbd3] mt-2 will-change-transform"
            variants={{
              rest: { opacity: 0, y: 10 },
              hover: { opacity: 1, y: 0 }
            }}
